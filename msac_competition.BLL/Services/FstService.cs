...
{
    public class FstService : BaseService<FstDTO, int>, IFstService
    {
        protected readonly IUnitOfWork UnitOfWork;

        public FstService(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        ...
        public FstDTO Create(CompetitionDTO newItem, bool shouldBeCommited = false)
        {
            throw new NotImplementedException();
        }
